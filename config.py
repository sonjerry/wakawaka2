...
# ESC 펄스 임계치 (캘리브레이션된 범위)
ESC_MIN_US      = 1600 # ESC 최소값 (후진/브레이크) - 1700에서 100us 아래
ESC_NEUTRAL_US  = 1700 # ESC 중립값 (정지)
ESC_MAX_US      = 1800 # ESC 최대값 (전진) - 8% 속도에 해당
ESC_TRIM_US     = 0    # ESC 트림 조정값

# ESC 아밍을 위한 특별한 펄스값들 (캘리브레이션된 범위 사용)
ESC_ARM_MIN_US  = 1600 # 아밍 시 최소 펄스
ESC_ARM_MAX_US  = 1800 # 아밍 시 최대 펄스
